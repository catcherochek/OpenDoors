...
class ControllerExtensionModuleAdaptiveimport extends Controller {
	...
	public function index() {
		...
		$this->language->load('extension/module/adaptiveimport');//загрузка языкового файла
...
//подгрузка модели
 		$this->load->model('extension/module/adaptiveimport');
 		
 		$error = false;
 		$this->model_extension_module_adaptiveimport->deleteProgress();
...
// 		);
		...
		try {
			...
			if ($this->model_extension_module_adaptiveimport->exportXLS()) {
...
// 		header('Content-Type: application/json');
 		echo "fsafsafsfsddasasfedsaeffews";
 		exit;
	}
