  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        <div class = "buttonajax" style="background-color: yellow;">ButtonAjax</div>
        <p class ="texttoaffect">Текст оторый будет изменен аяксом</p>
...
$(".texttoaffect").html("fvsdfsdfsd");
$(".buttonajax").click(function(){
    $.ajax({url: "index.php?token=" + token + "&route=extension/module/adaptiveimport/ajaxgenerate", success: function(result){
        $(".texttoaffect").html(result);
    }});
});
</script>
